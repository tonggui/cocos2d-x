...
CCTextBitmap* CCTextBitmap::createCCTextBitmap(const char *text, const char *pFontName, const Device::TextAlign eAlignMask, int width_, int height_, double fontSize)
{
    ...
    return createCCTextBitmap(text, pFontName, 
        fontSize, 0xFF, 0xFF, 0xFF, eAlignMask,
        width_, height_, 
        false, 1, 1, 1, 
        false, 1, 1, 1, 1);
}

CCTextBitmap* CCTextBitmap::createCCTextBitmap(const char *text, const char *pFontName, const float fontTintR, const float fontTintG, const float fontTintB,
                                        const Device::TextAlign eAlignMask, int width_, int height_, double fontSize)
{
    return createCCTextBitmap(text, pFontName,fontSize,
